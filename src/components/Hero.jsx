...
export default function Hero() {
  return (
    <section
      ...
      style={{
        backgroundImage: "url(/placeholder.svg?height=1080&width=1920&query=academia%20crossfit%20impactante%20escura)",
      }}
    >
      <Header />
      ...
      <div className="relative z-10 p-4 max-w-4xl mx-auto">
        ...
        <motion.a
          href="#plans"
          className="inline-block bg-accent text-primary font-bold py-3 px-8 rounded-full text-lg hover:bg-accent-dark transition-colors duration-300"
